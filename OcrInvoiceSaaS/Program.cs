...
builder.Services.AddScoped<SpendAnalyticsService>();
builder.Services.AddScoped<MtdVatService>();
builder.Services.AddScoped<PdfReportService>();
builder.Services.AddHttpClient("WebhookClient");
builder.Services.AddHttpClient("MtdVatClient");

// ── UK Compliance & Lookups ───────────────────────────────────────────────────
builder.Services.AddScoped<CompaniesHouseService>();
builder.Services.AddScoped<HmrcVatService>();
builder.Services.AddHttpClient("CompaniesHouseClient");
builder.Services.AddHttpClient("HmrcVatClient");
...
builder.Services.AddScoped<InvoiceLockService>();
builder.Services.AddHttpClient("XeroClient");
