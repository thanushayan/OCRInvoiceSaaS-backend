...
/// Sends a weekly spend digest email to users who have opted in
/// via NotificationPreference.WeeklyDigestEmail = true.
/// </summary>
...
public class WeeklyDigestJob : IJob
{
    ...
    public async Task Execute(IJobExecutionContext context)
    {
        ...
        // Users who opted in to weekly digest
        ...
        foreach (var pref in optedIn)
        {
            try
            {
                ...
                // Gather last week's invoice stats across all companies
