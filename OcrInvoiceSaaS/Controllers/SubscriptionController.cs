...
public class SubscriptionController : ControllerBase
{
    ...
    /// <summary>List all available subscription plans (public).</summary>
    [AllowAnonymous]
    ...
    /// <summary>Subscribe a company to a plan. Supersedes any existing active subscription.</summary>
    ...
    /// <summary>Get the current active subscription for a company.</summary>
