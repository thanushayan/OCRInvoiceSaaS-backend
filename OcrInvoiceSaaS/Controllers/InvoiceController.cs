...
public class InvoiceController : ControllerBase
{
    ...
    /// <summary>List all invoices for a company.</summary>
    [HttpGet]
    ...
    /// <summary>Update extracted fields or status on an invoice.</summary>
    ...
    /// <summary>Trigger OCR processing on an uploaded invoice.</summary>
