...
public class InvoiceItemController : ControllerBase
{
    ...
    /// <summary>Add a line item to an invoice. Automatically recalculates invoice totals.</summary>
    [HttpPost]
    ...
    /// <summary>Update a specific line item.</summary>
    ...
    /// <summary>Remove a line item from an invoice.</summary>
