...
public class NotificationPreferenceService
{
    ...
    public async Task<ServiceResult<NotificationPreferenceResponse>> UpdateAsync(
        Guid userId, UpdateNotificationPreferenceRequest request)
    {
        var prefs = await GetOrCreateAsync(userId);
    ...
    {
        OcrCompletedEmail       = p.OcrCompletedEmail,
        OcrCompletedInApp       = p.OcrCompletedInApp,
        ApprovalRequiredEmail   = p.ApprovalRequiredEmail,
        ApprovalRequiredInApp   = p.ApprovalRequiredInApp,
        ApprovalCompletedEmail  = p.ApprovalCompletedEmail,
        ApprovalCompletedInApp  = p.ApprovalCompletedInApp,
        DuplicateFlaggedEmail   = p.DuplicateFlaggedEmail,
        DuplicateFlaggedInApp   = p.DuplicateFlaggedInApp,
        DueDateReminderEmail    = p.DueDateReminderEmail,
        DueDateReminderInApp    = p.DueDateReminderInApp,
        MentionEmail            = p.MentionEmail,
        MentionInApp            = p.MentionInApp,
        BulkOcrCompletedEmail   = p.BulkOcrCompletedEmail,
        BulkOcrCompletedInApp   = p.BulkOcrCompletedInApp,
