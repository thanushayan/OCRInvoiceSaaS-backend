...
public class NotificationService : INotificationService
{
    ...
    public async Task<ServiceResult<List<NotificationResponse>>> GetForUserAsync(Guid userId, bool unreadOnly = false)
    {
        ...
        var notifications = await query
            ...
            .Take(50)
            .Select(n => new NotificationResponse { Id = n.Id, Title = n.Title, Message = n.Message, Type = n.Type, IsRead = n.IsRead, CreatedAt = n.CreatedAt })
            .ToListAsync();
    ...
    {
        IQueryable<Notification> query = _db.Notifications.Where(n => n.UserId == userId && !n.IsRead);
        if (request.Ids != null && request.Ids.Count > 0) query = query.Where(n => request.Ids.Contains(n.Id));
